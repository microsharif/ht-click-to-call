...
*click call admin  
*/
class Ht_Click_Call_Admin_Setting
{
	...
	public function click_call_admin_assets($hook){
		...
		if($hook == 'toplevel_page_ht-click-call-setting-page'){
			...
			$pesoninfo_enable  	 = ht_clickcall_get_option('person_info_disable','clickcall_general_tab','off');
			...
			$call_num_icon_enable= ht_clickcall_get_option('nunber_icon_disable','clickcall_general_tab','off');
...
new Ht_Click_Call_Admin_Setting();
